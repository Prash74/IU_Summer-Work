...
"""Facedetection A Script to run the HiBench Benchmark on different clouds

Usage:
  Facedetection <cloud> <os> <data_size>
  Facedetection --help
  Facedetection --version
...
class BenchmarkRunner(AbstractBenchmarkRunner):
    repo = 'git@github.com:Prash74/example-project-Facedetection'
    name_prefix = '{}-{}-'.format(os.getlogin(), 'Facedetection')
