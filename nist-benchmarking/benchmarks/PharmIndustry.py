...
"""PharmIndustry A Script to run the HiBench Benchmark on different clouds

Usage:
  PharmIndustry <cloud> <os> <data_size>
  PharmIndustry --help
  PharmIndustry --version
...
class BenchmarkRunner(AbstractBenchmarkRunner):
    repo = 'git@github.com:Prash74/example-project-PharmIndustry'
    name_prefix = '{}-{}-'.format(os.getlogin(), 'PharmIndustry')
