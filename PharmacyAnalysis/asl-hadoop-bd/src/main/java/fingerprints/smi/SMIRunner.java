...
public class SMIRunner extends Configured implements Tool {

	

	public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new SMIRunner(), args);
        System.exit(res);
    }
			...
			/*  // Create a new JobConf
			  ...
			  */
			   ...
			   // conf.set("yarn.scheduler.minimum-allocation-vcores", "3");
			    ...
			    job.setJarByClass(SMIRunner.class);
			    job.setMapperClass(SMIMapper.class);
